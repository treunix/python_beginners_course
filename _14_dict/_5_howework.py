...
def best_best_student(*, students: list[dict]) -> list[dict]:
    best_students = []
...
print(best_best_student(students=students))
...
#         if average_grades > best_average_grades:
#             best_average_grades = average_grades
#             best_students = [student]
#         elif average_grades == best_average_grades:
#             best_students.append(student)
#     return best_students
#
